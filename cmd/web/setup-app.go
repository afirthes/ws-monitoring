...
import (
	"flag"
	"fmt"
	"github.com/afirthes/ws-monitoring/internal/channeldata"
	"github.com/afirthes/ws-monitoring/internal/config"
	"github.com/afirthes/ws-monitoring/internal/driver"
	"github.com/afirthes/ws-monitoring/internal/handlers"
	"github.com/afirthes/ws-monitoring/internal/helpers"
...
func setupApp() (*string, error) {
	...
	identifier := flag.String("identifier", "wsmonitoring", "unique identifier")
	...
	databaseName := flag.String("db", "wsmonitoring", "database name")
	...
	preferenceMap["version"] = wsmonitoringVersion
